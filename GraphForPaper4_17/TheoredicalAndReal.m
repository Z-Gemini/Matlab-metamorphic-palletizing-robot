...
%     g2 = [1.3785,1.3859,1.3887,1.3941];
    ...
    hold on;
    plot(xt1+0.12,yt1-0.09,'color',[231/255,29/255,54/255],'linestyle','--' ,'linewidth',3);%二自由度末端轨迹
    hold on;

    plot(xc1+0.12,yc1-0.09,'color',[0,139/255,139/255],'linewidth',3);%单自由度末端轨迹
    hold on;
    plot(xc1+0.12,yc1-0.09,'color',[231/255,29/255,54/255],'linestyle','--' ,'linewidth',3);%单自由度末端轨迹
    hold on;


    plot(xt2+0.12,yt2-0.09,'color',[0,139/255,139/255],'linewidth',3);%单自由度末端轨迹
    hold on;
    plot(xt2+0.12,yt2-0.09,'color',[231/255,29/255,54/255],'linestyle','--' ,'linewidth',3);%单自由度末端轨迹
    hold on;

    plot(xc2+0.12,yc2-0.09,'color',[0,139/255,139/255],'linewidth',3);%单自由度末端轨迹
    hold on;
    plot(xc2+0.12,yc2-0.09,'color',[231/255,29/255,54/255],'linestyle','--' ,'linewidth',3);%单自由度末端轨迹
    hold on;
    
    plot(xt3+0.12,yt3-0.09,'color',[0,139/255,139/255],'linewidth',3);%二自由度末端轨迹
    hold on;
    plot(xt3+0.12,yt3-0.09,'color',[231/255,29/255,54/255],'linestyle','--' ,'linewidth',3);%二自由度末端轨迹
